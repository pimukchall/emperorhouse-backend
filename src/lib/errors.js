...
export const err         = (status, message, code) => new HttpError(status, message, code);
export const BadRequest  = (m = "คำขอไม่ถูกต้อง")        => err(400, m, "BAD_REQUEST");
export const Unauthorized= (m = "กรุณาเข้าสู่ระบบ")      => err(401, m, "UNAUTHORIZED");
export const Forbidden   = (m = "คุณไม่มีสิทธิ์ทำรายการนี้") => err(403, m, "FORBIDDEN");
export const NotFound    = (m = "ไม่พบข้อมูล")            => err(404, m, "NOT_FOUND");
export const Conflict    = (m = "ข้อมูลซ้ำ")               => err(409, m, "CONFLICT");
export const Internal    = (m = "เกิดข้อผิดพลาดในระบบ")    => err(500, m, "INTERNAL_ERROR");

/** แปลง error เป็น payload ให้ error handler ส่งต่อ */
